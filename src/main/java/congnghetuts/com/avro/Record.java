...
public class Record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8490040050420463692L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Record\",\"namespace\":\"congnghetuts.com.avro\",\"fields\":[{\"name\":\"enable\",\"type\":[\"null\",\"boolean\"]}]}");
   ...
   */
  public Record(java.lang.Boolean enable) {
    this.enable = enable;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: enable = (java.lang.Boolean)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static congnghetuts.com.avro.Record.Builder newBuilder() {
    return new congnghetuts.com.avro.Record.Builder();
  }
   ...
   * @return A new Record RecordBuilder
   */
  public static congnghetuts.com.avro.Record.Builder newBuilder(congnghetuts.com.avro.Record.Builder other) {
    if (other == null) {
      return new congnghetuts.com.avro.Record.Builder();
    } else {
      return new congnghetuts.com.avro.Record.Builder(other);
    }
  }
   ...
   * @return A new Record RecordBuilder
   */
  public static congnghetuts.com.avro.Record.Builder newBuilder(congnghetuts.com.avro.Record other) {
    if (other == null) {
      return new congnghetuts.com.avro.Record.Builder();
    } else {
      return new congnghetuts.com.avro.Record.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Record>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(congnghetuts.com.avro.Record.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(congnghetuts.com.avro.Record other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.enable)) {
        this.enable = data().deepCopy(fields()[0].schema(), other.enable);
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.Record.Builder setEnable(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.Record.Builder clearEnable() {
      enable = null;

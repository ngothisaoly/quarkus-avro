...
public class ObjectType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5621124890550372557L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ObjectType\",\"namespace\":\"congnghetuts.com.avro\",\"doc\":\"Day la vi du ve ObjectType\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"int\"]},{\"name\":\"name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
   ...
   */
  public static BinaryMessageEncoder<ObjectType> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a ObjectType instance decoded from the given buffer
   ...
   */
  public ObjectType(java.lang.Integer id, java.lang.String name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static congnghetuts.com.avro.ObjectType.Builder newBuilder() {
    return new congnghetuts.com.avro.ObjectType.Builder();
  }
   ...
   * @return A new ObjectType RecordBuilder
   */
  public static congnghetuts.com.avro.ObjectType.Builder newBuilder(congnghetuts.com.avro.ObjectType.Builder other) {
    if (other == null) {
      return new congnghetuts.com.avro.ObjectType.Builder();
    } else {
      return new congnghetuts.com.avro.ObjectType.Builder(other);
    }
  }
   ...
   * @return A new ObjectType RecordBuilder
   */
  public static congnghetuts.com.avro.ObjectType.Builder newBuilder(congnghetuts.com.avro.ObjectType other) {
    if (other == null) {
      return new congnghetuts.com.avro.ObjectType.Builder();
    } else {
      return new congnghetuts.com.avro.ObjectType.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ObjectType>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(congnghetuts.com.avro.ObjectType.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(congnghetuts.com.avro.ObjectType other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.ObjectType.Builder setId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.ObjectType.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.ObjectType.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public congnghetuts.com.avro.ObjectType.Builder clearName() {
      name = null;
